...
function buildSystemPrompt(visualStyle: string) {
  return [
    ...
    "- If characters must appear, describe them visually (age, gender presentation, hairstyle, clothing, distinguishing features) and keep them EXACTLY consistent across ALL scenes.",
    "- Describe WHERE and WHEN (Night, Sunset, Morning, Mid day, etc.) and show progression if time passes.",
